...
def _kpi_card(
    ...
    """การ์ด KPI ใบเดียว"""
    return (
        f'<div style="background-color:{bg_color}; border:1px solid {border}; border-radius:12px; padding:18px 10px; text-align:center; height:205px; box-sizing:border-box; display:flex; flex-direction:column; justify-content:center;">'
