...
def render(ctx):
    ...
    <div style="flex-grow:1; display:flex; flex-direction:column; justify-content:center; align-items:center; background-color:rgba(56,189,248,0.10); border:1.5px solid rgba(56,189,248,0.45); border-radius:12px; padding:10px 8px; margin-top:10px;">
