...
def render(ctx):
    ...
    <div style="font-size:14.5px; color:#FFFFFF; font-weight:bold; margin-bottom:4px; text-align:left;">FINAL RECOMMENDATION</div>
    ...
    <div style="display:flex; justify-content:space-between; margin-bottom:3px;"><span style="color:#FFFFFF;">Confidence Level</span><span style="color:#FFFFFF; font-weight:bold;">{conf_lvl}</span></div>
    <div style="display:flex; justify-content:space-between; margin-bottom:3px;"><span style="color:#FFFFFF;">Overall Score</span><span style="color:#FFFFFF; font-weight:bold;">{safe(ctx.stock_info.get('overall_score')):.1f}/100</span></div>
    <div style="display:flex; justify-content:space-between; margin-bottom:3px;"><span style="color:#FFFFFF;">Sector Rank</span><span style="color:#FFFFFF; font-weight:bold;">{sector_rank} / {n_sector}</span></div>
    </div></div>""", unsafe_allow_html=True)
    import base64
