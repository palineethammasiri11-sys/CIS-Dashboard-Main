...
def _metric_card(
    ...
    content_style = (
        f"font-size:17px;font-weight:700;color:{value_color};margin-top:4px;"
        "overflow:hidden;text-overflow:ellipsis;display:-webkit-box;"
        "-webkit-line-clamp:2;-webkit-box-orient:vertical;line-height:1.35;"
        if is_summary
        else
        f"font-size:22px;font-weight:900;color:{value_color};margin-top:4px;"
    ...
    <div style="{_card_style(
        ...
        <div style="font-size:16px;font-weight:800;color:{'#FFFFFF' if card_bg != BG_CARD else TEXT_MUTED};letter-spacing:.5px;">
            {label}
        </div>
        <div style="{content_style}">
            {value}
        </div>
        <div style="font-size:16px;color:{'#FFFFFF' if card_bg != BG_CARD else TEXT_MUTED};margin-top:3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
            {sub}
        </div>
    </div>
    """
...
def render(ctx):
    ...
    <div style="margin-bottom:20px;">
        <div style="font-size:30px; font-weight:700; color:#0F172A; letter-spacing:0.3px;">
            ENTRY TIMING
        </div>
