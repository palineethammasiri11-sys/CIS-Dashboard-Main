...
def _metric_card(
    ...
    content_style = (
        f"font-size:13px;font-weight:700;color:{value_color};margin-top:4px;"
    ...
    <div style="{_card_style(
        ...
        <div style="font-size:13px;font-weight:800;color:{'#FFFFFF' if card_bg != BG_CARD else TEXT_MUTED};letter-spacing:.5px;">
            {label}
        </div>
        <div style="{content_style}">
            {value}
        </div>
        <div style="font-size:12px;color:{'#FFFFFF' if card_bg != BG_CARD else TEXT_MUTED};margin-top:3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
            {sub}
        </div>
    </div>
    """
