...
def render(ctx):
    ...
    with r1_c1:
        st.markdown(
            f"""
            <div style="background:#FFFFFF;border:2px solid {val_color};border-radius:12px;padding:14px;min-height:170px;display:flex;flex-direction:column;justify-content:space-between;">
                ...
                <div style="display:flex;align-items:center;gap:12px;">
                    <div style="width:76px;height:76px;border-radius:50%;background:conic-gradient({val_color} 0% {val_score}%,#E2E8F0 {val_score}% 100%);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                        <div style="width:62px;height:62px;border-radius:50%;background:#FFFFFF;display:flex;flex-direction:column;align-items:center;justify-content:center;">
                    ...
                    <div>
                        <div style="color:{val_color};font-size:16.5px;font-weight:bold;line-height:1.2;">
                            {val_status}
                        </div>
                        <div style="font-size:13px;color:#475569;line-height:1.35;margin-top:3px;">
                            Margin of Safety อยู่ที่ {val_mos:.1f}% เมื่อเทียบกับมูลค่าพื้นฐานที่แท้จริง
                        </div>
                        <div style="color:{val_color};font-size:14.5px;letter-spacing:1px;margin-top:4px;">
    ...
    with r1_c2:
        st.markdown(
            f"""
            <div style="background:#FFFFFF;border:1px solid #E2E8F0;border-radius:12px;padding:12px;min-height:170px;display:flex;flex-direction:column;justify-content:space-between;">
                <div style="font-size:13px;font-weight:bold;color:#64748B;">CURRENT PRICE</div>
                <div>
                    <div style="font-size:21px;font-weight:bold;color:#0F172A;line-height:1;">
                        {val_cur_price:.2f}
                        <span style="font-size:13.5px;color:#64748B;">THB</span>
                    </div>
        ...
        st.markdown(
            ...
            <div style="background:#FFFFFF;border:1px solid #E2E8F0;border-radius:12px;padding:12px;min-height:170px;display:flex;flex-direction:column;justify-content:space-between;">
                <div style="font-size:13px;font-weight:bold;color:#64748B;">
                    ...
                    <br>
                    <span style="font-size:12px;color:#64748B;">(BLENDED: 55% DCF + 45% P/E)</span>
                </div>
                <div style="font-size:21px;font-weight:bold;color:#0F172A;line-height:1;">
                    {val_base:.2f}
                    <span style="font-size:13.5px;color:#64748B;">THB</span>
    ...
    with r1_c4:
        st.markdown(
            f"""
            <div style="background:#FFFFFF;border:1px solid #E2E8F0;border-radius:12px;padding:12px;min-height:170px;display:flex;flex-direction:column;justify-content:space-between;text-align:center;">
                <div style="font-size:13px;font-weight:bold;color:#64748B;text-align:left;">
                    MARGIN OF SAFETY
                </div>
                <div style="font-size:21px;font-weight:bold;color:{val_color};line-height:1;">
                    {val_mos:.1f}%
                </div>
                <div style="display:flex;justify-content:center;">
                    <div style="background:rgba(16,185,129,.15);border:1px solid #10B981;border-radius:50%;width:36px;height:36px;display:flex;align-items:center;justify-content:center;font-size:15px;">
                        🛡️
                    </div>
                </div>
            </div>
    ...
    with r1_c5:
        ...
        st.markdown(
            ...
            <div style="background:#FFFFFF;border:1px solid #E2E8F0;border-radius:12px;padding:12px;min-height:170px;display:flex;flex-direction:column;justify-content:space-between;text-align:center;">
                ...
                <div style="font-size:18.5px;font-weight:bold;color:{val_color};line-height:1;">
                    {conf.upper()}
                </div>
            </div>
            """,
    ...
    with r1_c6:
        st.markdown(
            ...
            <div style="background:{val_color};border:1px solid {val_color};border-radius:12px;padding:12px;min-height:170px;display:flex;flex-direction:column;justify-content:space-between;text-align:center;">
                <div style="font-size:13px;font-weight:bold;color:#FFFFFF;text-align:left;">
                    RECOMMENDATION
                </div>
                <div style="font-size:17.5px;font-weight:bold;color:#FFFFFF;line-height:1.1;">
                    {val_rec_label}
                </div>
            </div>
            """,
    ...
    with r2_c1:
        ...
        st.markdown(
            ...
            <div style="background:#FFFFFF;border:1px solid #E2E8F0;border-radius:12px;padding:14px;min-height:315px;display:flex;flex-direction:column;justify-content:space-between;">
                <div style="font-size:14px;font-weight:bold;color:#64748B;letter-spacing:.5px;">
                ...
                <div style="display:grid;grid-template-columns:1fr 1.1fr 1fr;gap:6px;margin-top:6px;">
                    <div style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:8px;padding:8px 4px;text-align:center;">
                        ...
                        <div style="color:#0F172A;font-size:16px;font-weight:bold;margin-top:4px;">
                            {val_bear:.2f} <span style="font-size:12px;color:#64748B;">THB</span>
                        </div>
                    </div>
                    ...
                    <div style="background:#FFFBEB;border:1.5px solid #F59E0B;border-radius:8px;padding:8px 4px;text-align:center;">
                        ...
                        <div style="color:#0F172A;font-size:16.5px;font-weight:bold;margin-top:4px;">
                            {val_base:.2f} <span style="font-size:12px;color:#64748B;">THB</span>
                        </div>
                    </div>
                    ...
                    <div style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:8px;padding:8px 4px;text-align:center;">
                        ...
                        <div style="color:#0F172A;font-size:16px;font-weight:bold;margin-top:4px;">
                            {val_bull:.2f} <span style="font-size:12px;color:#64748B;">THB</span>
                        </div>
                    </div>
                </div>
                ...
                <div style="background:rgba(16,185,129,.08);border-radius:6px;padding:6px 8px;display:flex;align-items:flex-start;gap:6px;margin-top:10px;">
                    ...
                    <div style="font-size:12.5px;color:#475569;line-height:1.3;">
                        ...
                        <span style="color:#64748B;">
                            คำนวณจากงบการเงินปีล่าสุด (FY{fy})
    ...
    with r2_c2:
        st.markdown(
            ...
            <div style="background:#FFFFFF;border:1px solid #E2E8F0;border-radius:12px;padding:14px;min-height:315px;display:flex;flex-direction:column;justify-content:space-between;">
                ...
                <div style="font-size:13px;color:#475569;line-height:1.45;display:flex;flex-direction:column;gap:8px;margin:auto 0;">
                    <div style="display:flex;gap:6px;">
                        <span style="color:#10B981;">✔</span>
                        <div>
                            <b>Fair Value (Blended): {val_base:.2f} THB</b><br>
                    ...
                    <div style="display:flex;gap:6px;">
                        <span style="color:#10B981;">✔</span>
                        <div>
                            <b>Margin of Safety: {val_mos:.1f}%</b><br>
                            <span style="color:#64748B;font-size:12.5px;">
                ...
                <div style="display:flex;flex-direction:column;gap:10px;margin:auto 0;">
                    <div>
                        ...
                        <div style="background:#E2E8F0;height:9px;border-radius:4px;overflow:hidden;">
                            <div style="background:{val_color};width:{val_score}%;height:100%;"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div style="background:#E2E8F0;height:9px;border-radius:4px;overflow:hidden;">
                            <div style="background:{val_color};width:{safety_score}%;height:100%;"></div>
                        </div>
                    </div>
                </div>

                <div style="display:flex;justify-content:space-between;align-items:center;border-top:1px solid #E2E8F0;padding-top:8px;">
                    <span style="font-size:13.5px;font-weight:bold;color:#475569;">
                        OVERALL FAIR VALUE SCORE
                    </span>
                    <span style="font-size:18.5px;font-weight:bold;color:{val_color};">
                        {val_score}
    ...
    with d_c1:
        st.markdown(
            f"""
            <div style="background:#FFFFFF;border:1px solid #E2E8F0;border-radius:10px;padding:12px;min-height:190px;">
            ...
            <div style="background:#FFFFFF;border:1px solid #E2E8F0;border-radius:10px;padding:12px;min-height:190px;">
                ...
                <table style="width:100%;font-size:13px;color:#475569;border-collapse:collapse;margin-top:6px;">
                    <tr>
                        ...
                        <td style="color:{val_color};font-weight:bold;">
                            {val_mos:.1f}%
                        </td>
                    </tr>
                </table>
    ...
    with r4_c1:
        ...
        st.markdown(
            f"""
            <div style="background:#FFFFFF;border:1px solid #E2E8F0;border-radius:12px;padding:14px;min-height:220px;display:flex;flex-direction:column;justify-content:space-between;">
                <div style="font-size:13.5px;font-weight:bold;color:#64748B;letter-spacing:.5px;">
                    DCF ASSUMPTIONS
                    <span style="font-size:11.5px;font-weight:normal;">
    ...
    with r4_c2:
        st.markdown(
            """
            <div style="background:#FFFFFF;border:1px solid #E2E8F0;border-radius:12px 12px 0 0;padding:12px 16px 0 16px;">
                <div style="font-size:13.5px;font-weight:bold;color:#64748B;letter-spacing:.5px;">
