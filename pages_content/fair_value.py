...
def render(ctx):
    ...
    with r1_c1:
        st.markdown(f"""<div style="background-color:#FFFFFF; border:2px solid #FF9900; border-radius:12px; padding:14px; min-height:170px; display:flex; flex-direction:column; justify-content:space-between;">
    ...
    <span style="font-size:19px; font-weight:bold; color:#0F172A; line-height:1;">{val_score}</span><span style="font-size:12px; color:#64748B;">/100</span>
    </div></div>
