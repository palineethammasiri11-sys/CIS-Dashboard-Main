...
def render(ctx):
    ...
    val_stars = min(5, max(1, round(val_score / 20)))
        ...
        st.markdown(
            textwrap.dedent(
                f"""
                <div style="background-color:#FFFFFF; border:2px solid {val_color}; border-radius:12px; padding:14px; min-height:170px; display:flex; flex-direction:column; justify-content:space-between;">
                    ...
                    <div style="display:flex; align-items:center; gap:12px; margin-top:10px;">
                        <div style="width:76px; height:76px; border-radius:50%; background:conic-gradient({val_color} 0% {val_score}%, #E2E8F0 {val_score}% 100%); display:flex; align-items:center; justify-content:center; flex-shrink:0;">
                            <div style="width:62px; height:62px; border-radius:50%; background-color:#FFFFFF; display:flex; flex-direction:column; align-items:center; justify-content:center;">
                                <span style="font-size:19px; font-weight:bold; color:#0F172A; line-height:1;">
                                    {val_score}
                                </span>
    ...
    <div style="color:#C084FC; font-size:13.5px; font-weight:bold;">Blended Fair Value</div><div style="color:#64748B; font-size:12px;">55% DCF + 45% P/E</div>
