...
def _html(content):
    """
    ป้องกัน HTML ถูก Streamlit ตีความเป็น code block
    เนื่องจาก indentation ใน triple-quoted string
    """
    st.markdown(
...
def render(ctx):
    ...
    # SECOND ROW
    # =====================================================
    _html("<div style='margin-top:22px;'></div>")
